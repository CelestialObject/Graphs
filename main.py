...
def main():
  ...
  G.add_edge(Vertex('a'), Vertex('d'))
  G.add_edge(Vertex('d'), Vertex('b'))
  G.add_edge(Vertex('b'), Vertex('e'))
  G.add_edge(Vertex('e'), Vertex('d'))
  G.add_edge(Vertex('c'), Vertex('e'))
  G.add_edge(Vertex('c'), Vertex('f'))
  G.add_edge(Vertex('f'), Vertex('f'))
  # G.add_edge(Vertex('s'), Vertex('z'))
  # G.add_edge(Vertex('y'), Vertex('x'))
  # G.add_edge(Vertex('x'), Vertex('z'))
  # G.add_edge(Vertex('z'), Vertex('y'))
